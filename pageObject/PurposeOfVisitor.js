class PurposeOfVisit{
    constructor(page){
        ...
        this.purposeSettings = page.locator("//span[@class='noti-dot'][normalize-space()='Purpose of Visitor Entry']");
    ...
    async createPurpose(purposeName){
        ...
        await this.page.getByLabel('Purpose of Visit *').fill(purposeName);
    ...
    async updatePurpose(purposeName, updatedName){
        ...
        await this.page.getByLabel('Purpose of Visit *').click();
        await this.page.getByLabel('Purpose of Visit *').fill(updatedName);
        await this.page.getByRole('button', { name: 'Submit' }).click();
    }
